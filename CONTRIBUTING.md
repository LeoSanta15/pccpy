...
4. Todo cambio numérico debe ir acompañado de una prueba que lo compare con una
   ...
   no con la propia salida de spyc.
...
Si un resultado difiere de Minitab, abre un issue con: los datos (o una muestra
reproducible), la llamada a spyc, el resultado de spyc y el de Minitab (con la
versión de Minitab y las opciones usadas).
